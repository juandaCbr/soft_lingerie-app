...
import { Truck, MapPin, Lock, ShieldCheck, ArrowLeft, User, CreditCard, Loader2, Smartphone, Bike, Mail } from 'lucide-react';
...
export default function CheckoutPage() {
  ...
  /** Formato básico de correo (el input ya es type="email"). */
